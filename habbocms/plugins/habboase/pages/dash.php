<h1>Welcome, <span><?php echo $users->data('username'); ?></span>!</h1>
            ...
            <ul class="dash">
              <li>
                <a href="#" title="Write a new article" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/8_48x48.png" alt="" />
                  <span>New article</span>
                </a>
              </li>
              <li>
                <a href="#" title="What your team posted" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/7_48x48.png" alt="" />
                  <span>Last articles</span>
                </a>
              </li>
              <li>
                <a href="#" title="Manage users and accounts" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/16_48x48.png" alt="" />
                  <span>Users</span>
                </a>
              </li>
              <li>
                <a href="#" title="Your site's statistics" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/4_48x48.png" alt="" />
                  <span>Statistics</span>
                </a>
              </li>
              <li>
                <a href="#" title="Bandwidth and traffic" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/14_48x48.png" alt="" />
                  <span>Bandwidth</span>
                </a>
              </li>
              <li>
                <a href="#" title="Server warnings" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/5_48x48.png" alt="" />
                  <span>Server warnings</span>
                </a>
              </li>
              <li>
                <a href="#" title="Manage downloads" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/3_48x48.png" alt="" />
                  <span>Downloads</span>
                </a>
              </li>
              <li>
                <a href="#" title="Lorem ipsum" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/9_48x48.png" alt="" />
                  <span>Listings</span>
                </a>
              </li>
              <li>
                <a href="#" title="Users' photo gallery" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/1_48x48.png" alt="" />
                  <span>Gallery</span>
                </a>
              </li>
              <li>
                <a href="#" title="0 new messages" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/25_48x48.png" alt="" />
                  <span>Inbox</span>
                </a>
              </li>
              <li>
                <a href="#" title="Browse for files" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/21_48x48.png" alt="" />
                  <span>File browser</span>
                </a>
              </li>
              <li>
                <a href="#" title="Calculator" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/30_48x48.png" alt="" />
                  <span>Calculator</span>
                </a>
              </li>
              <li>
                <a href="#" title="RSS Feeds" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/29_48x48.png" alt="" />
                  <span>Feeds</span>
                </a>
              </li>
              <li>
                <a href="#" title="Lorem ipsum" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/20_48x48.png" alt="" />
                  <span>Media</span>
                </a>
              </li>
              <li>
                <a href="#" title="Lorem ipsum" class="tooltip">
                  <img src="<?php echo MEDIA; ?>assets/icons/26_48x48.png" alt="" />
          ...
          <hr />
          <h1>Website and game log</h1>
          <div class="pad20">
            All important actions that recently have been done is displayed here, you can see a more detailed log <a href=''>here.</a><br>
            <textarea style="width: 100%; height: 200px" readonly="readonly"><?php
                $result = $sql->query("SELECT * FROM habbocms_logs WHERE level = '3' ORDER BY time DESC LIMIT 20");
                while($row = $sql->fetch($result)) {
                  echo "[" . $core->timeToDate($row['time'], 'd/m/Y G:i:s') . " " . $users->data('username', $row['user_id']) . "] " . $row['action'] . "\n";
                }
              ?></textarea>
          </div>
          <hr />
